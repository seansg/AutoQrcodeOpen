...
選項:
  --clean-logs           啟動時清除舊日誌檔案 (預設: 啟用)
  --keep-logs N          保留最近 N 個日誌檔案 (預設: 0 = 刪除全部)
  -h, --help             顯示說明訊息
```
...
# 保留最近 3 個日誌,刪除其他
python3 AutoLINE_scan_qrcode.command --keep-logs 3
```
...
2026-01-18 13:30:00 - INFO - 📝 日誌檔案: /path/to/logs/qrcode_monitor_20260118_133000.log
